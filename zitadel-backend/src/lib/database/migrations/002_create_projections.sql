-- Migration: 002_create_projections
-- Description: Create projection tables for CQRS read models
-- Date: 2025-10-04
...
CREATE TRIGGER IF NOT EXISTS update_projection_states_updated_at BEFORE UPDATE ON projection_states
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER IF NOT EXISTS update_users_projection_updated_at BEFORE UPDATE ON users_projection
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER IF NOT EXISTS update_organizations_projection_updated_at BEFORE UPDATE ON organizations_projection
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER IF NOT EXISTS update_projects_projection_updated_at BEFORE UPDATE ON projects_projection
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
