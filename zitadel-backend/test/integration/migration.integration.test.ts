...
describe('Migration System Integration', () => {
  ...
  describe('Fresh Start', () => {
    ...
    it('should set correct schema version', async () => {
      ...
      // Phase 2 migrations: 002_28 (users), 002_29 (user_metadata), 002_30 (restore FKs), 002_31 (login_names)
      expect(version).toBe(43); // Updated count: 39 original + 4 Phase 2 migrations
    });
  });
  ...
  describe('Idempotent Operations', () => {
    ...
    it('should not duplicate migration records', async () => {
      ...
      // Should have 43 records (one per migration step, including Phase 2 migrations)
  ...
  describe('Resume from Last State', () => {
    it('should resume after partial migration', async () => {
      ...
      expect(migrations1.length).toBe(43);
    });
  ...
  describe('Migration Status', () => {
    ...
    it('should list all migrations', async () => {
      ...
      expect(applied.length).toBe(43);
      expect(applied[0].version).toBe(1);
      expect(applied[applied.length - 1].version).toBe(43);
